...
You can install [the release package built by Github CI](https://github.com/hoshiizumiya/actions).

To install:
1. Download the correct package built for your CPU architecture, eg: x64 ARM64
2. Unzip the packages, there will be two projects in the folder.
