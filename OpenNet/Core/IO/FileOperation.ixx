export module OpenNet.Core.IO.FileOperation;
...
export namespace winrt::OpenNet::Core::IO
{
	...
	public:
		...
		static std::uint64_t GetDirectorySize(const std::wstring& path);

		// Get available free space
		static std::uint64_t GetAvailableSpace(const std::wstring& path);
	};
}
