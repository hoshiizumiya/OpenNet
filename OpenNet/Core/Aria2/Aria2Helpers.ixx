/*
 * PROJECT:   OpenNet
 * FILE:      Core/Aria2/Aria2Helpers.ixx
...
export module OpenNet.Core.Aria2.Aria2Helpers;

import winrt.Windows.Foundation;

export namespace OpenNet::Core::Aria2::Helpers
{
	// ---------------------------------------------------------------
	...
	public:
		...
		ScopeExit(ScopeExit&& o) noexcept : m_fn(std::move(o.m_fn)), m_active(o.m_active)
		{
			o.m_active = false;
		}
	...
	template <typename F>
	inline ScopeExit<F> MakeScopeExit(F&& fn)
	{
