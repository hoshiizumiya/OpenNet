...
namespace winrt::OpenNet::ViewModels::implementation
{
	struct RSSItemViewModel : RSSItemViewModelT<RSSItemViewModel>
	{
		...
		hstring TorrentLink() const
		{
			return m_torrentLink;
		}
		hstring PubDate() const
		{
			return m_pubDate;
		}
		...
		hstring FeedId() const
		{
			return m_feedId;
		}
		hstring ItemGuid() const
		{
			return m_itemGuid;
		}
	...
	struct RSSFeedViewModel : RSSFeedViewModelT<RSSFeedViewModel>
	{
		...
		hstring SavePath() const
		{
			return m_savePath;
		}
		void SavePath(hstring const& value);
		int32_t UpdateIntervalMinutes() const
		{
		...
		hstring LastUpdated() const
		{
			return m_lastUpdated;
		}
		int32_t ItemCount() const;
		Windows::Foundation::Collections::IObservableVector<OpenNet::ViewModels::RSSItemViewModel> Items() const
		{
			return m_items;
		}
	...
	struct RSSViewModel : RSSViewModelT<RSSViewModel>
	{
		...
		Windows::Foundation::Collections::IObservableVector<OpenNet::ViewModels::RSSFeedViewModel> Feeds() const
		{
			return m_feeds;
		}
		OpenNet::ViewModels::RSSFeedViewModel SelectedFeed() const
		{
			return m_selectedFeed;
		}
		void SelectedFeed(OpenNet::ViewModels::RSSFeedViewModel const& value);
		OpenNet::ViewModels::RSSItemViewModel SelectedItem() const
		{
			return m_selectedItem;
		}
		void SelectedItem(OpenNet::ViewModels::RSSItemViewModel const& value);
		bool HasSelectedFeed() const
		{
			return m_selectedFeed != nullptr;
		}
		bool IsLoading() const
		{
			return m_isLoading;
		}
		hstring StatusMessage() const
		{
