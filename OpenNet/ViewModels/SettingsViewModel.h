...
namespace winrt::OpenNet::ViewModels::implementation
{
    ...
    public:
        ...
        void UserName(std::wstring_view value) { SetProperty(m_userName, std::wstring(value), L"UserName"); }

        std::wstring DeviceName() const { return m_deviceName; }
        void DeviceName(std::wstring_view value) { SetProperty(m_deviceName, std::wstring(value), L"DeviceName"); }

        std::wstring DefaultSavePath() const { return m_defaultSavePath; }
        void DefaultSavePath(std::wstring_view value) { SetProperty(m_defaultSavePath, std::wstring(value), L"DefaultSavePath"); }

        bool StartWithWindows() const { return m_startWithWindows; }
        void StartWithWindows(bool value) { SetProperty(m_startWithWindows, value, L"StartWithWindows"); }

        bool MinimizeToTray() const { return m_minimizeToTray; }
        void MinimizeToTray(bool value) { SetProperty(m_minimizeToTray, value, L"MinimizeToTray"); }

        bool ShowNotifications() const { return m_showNotifications; }
        void ShowNotifications(bool value) { SetProperty(m_showNotifications, value, L"ShowNotifications"); }
        ...
        bool EnableUPnP() const { return m_enableUPnP; }
        void EnableUPnP(bool value) { SetProperty(m_enableUPnP, value, L"EnableUPnP"); }

        bool EnableIPv6() const { return m_enableIPv6; }
        void EnableIPv6(bool value) { SetProperty(m_enableIPv6, value, L"EnableIPv6"); }

        uint32_t ConnectionTimeout() const { return m_connectionTimeout; }
        void ConnectionTimeout(uint32_t value) { SetProperty(m_connectionTimeout, value, L"ConnectionTimeout"); }

        uint32_t MaxConcurrentConnections() const { return m_maxConcurrentConnections; }
        void MaxConcurrentConnections(uint32_t value) { SetProperty(m_maxConcurrentConnections, value, L"MaxConcurrentConnections"); }

        // 新增的IPv4/IPv6和协议设置 / New IPv4/IPv6 and Protocol Settings
        Models::IPProtocolPriority ProtocolPriority() const { return m_protocolPriority; }
        ...
        Models::ConnectionProtocol PreferredProtocol() const { return m_preferredProtocol; }
        ...
        std::wstring CustomSTUNServer() const { return m_customSTUNServer; }
        void CustomSTUNServer(std::wstring_view value) { SetProperty(m_customSTUNServer, std::wstring(value), L"CustomSTUNServer"); }

        // 传输设置 / Transfer Settings
        uint64_t MaxFileSize() const { return m_maxFileSize; }
        ...
        uint64_t BandwidthLimit() const { return m_bandwidthLimit; }
        ...
        void EnableCompression(bool value) { SetProperty(m_enableCompression, value, L"EnableCompression"); }

        bool EnableEncryption() const { return m_enableEncryption; }
        void EnableEncryption(bool value) { SetProperty(m_enableEncryption, value, L"EnableEncryption"); }

        bool EnableResume() const { return m_enableResume; }
        void EnableResume(bool value) { SetProperty(m_enableResume, value, L"EnableResume"); }

        bool VerifyIntegrity() const { return m_verifyIntegrity; }
        void VerifyIntegrity(bool value) { SetProperty(m_verifyIntegrity, value, L"VerifyIntegrity"); }
        ...
        EncryptionLevel CurrentEncryptionLevel() const { return m_encryptionLevel; }
        ...
        bool AllowAnonymousConnections() const { return m_allowAnonymousConnections; }
        void AllowAnonymousConnections(bool value) { SetProperty(m_allowAnonymousConnections, value, L"AllowAnonymousConnections"); }

        // 隐私设置 / Privacy Settings
        bool ShareDeviceInfo() const { return m_shareDeviceInfo; }
        void ShareDeviceInfo(bool value) { SetProperty(m_shareDeviceInfo, value, L"ShareDeviceInfo"); }

        bool ShareNetworkInfo() const { return m_shareNetworkInfo; }
        void ShareNetworkInfo(bool value) { SetProperty(m_shareNetworkInfo, value, L"ShareNetworkInfo"); }

        bool AllowRemoteAccess() const { return m_allowRemoteAccess; }
        void AllowRemoteAccess(bool value) { SetProperty(m_allowRemoteAccess, value, L"AllowRemoteAccess"); }

        // 高级设置 / Advanced Settings
        bool EnableDebugLogging() const { return m_enableDebugLogging; }
        void EnableDebugLogging(bool value) { SetProperty(m_enableDebugLogging, value, L"EnableDebugLogging"); }

        uint32_t LogRetentionDays() const { return m_logRetentionDays; }
        void LogRetentionDays(uint32_t value) { SetProperty(m_logRetentionDays, value, L"LogRetentionDays"); }

        std::wstring LogPath() const { return m_logPath; }
        void LogPath(std::wstring_view value) { SetProperty(m_logPath, std::wstring(value), L"LogPath"); }

        bool EnableTelemetry() const { return m_enableTelemetry; }
        void EnableTelemetry(bool value) { SetProperty(m_enableTelemetry, value, L"EnableTelemetry"); }
        ...
        void CurrentTheme(Theme value)
        {
            if (SetProperty(m_currentTheme, value, L"CurrentTheme"))
            {
                RaisePropertyChanged(L"CurrentThemeText");
            }
        }
        ...
        std::wstring LastSaved() const { return m_lastSaved; }
        void LastSaved(std::wstring_view value) { SetProperty(m_lastSaved, std::wstring(value), L"LastSaved"); }

        // 命令 / Commands (getters)
        winrt::Microsoft::UI::Xaml::Input::ICommand SaveSettingsCommand() const { return m_saveSettingsCommand; }
        winrt::Microsoft::UI::Xaml::Input::ICommand ResetSettingsCommand() const { return m_resetSettingsCommand; }
        winrt::Microsoft::UI::Xaml::Input::ICommand ImportSettingsCommand() const { return m_importSettingsCommand; }
        winrt::Microsoft::UI::Xaml::Input::ICommand ExportSettingsCommand() const { return m_exportSettingsCommand; }
        winrt::Microsoft::UI::Xaml::Input::ICommand SelectSavePathCommand() const { return m_selectSavePathCommand; }
        winrt::Microsoft::UI::Xaml::Input::ICommand SelectLogPathCommand() const { return m_selectLogPathCommand; }
        winrt::Microsoft::UI::Xaml::Input::ICommand AddSTUNServerCommand() const { return m_addSTUNServerCommand; }
        winrt::Microsoft::UI::Xaml::Input::ICommand RemoveSTUNServerCommand() const { return m_removeSTUNServerCommand; }
        winrt::Microsoft::UI::Xaml::Input::ICommand TestNetworkCommand() const { return m_testNetworkCommand; }
        winrt::Microsoft::UI::Xaml::Input::ICommand ClearLogsCommand() const { return m_clearLogsCommand; }
