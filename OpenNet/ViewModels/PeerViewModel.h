...
namespace OpenNet::ViewModels
{
	...
	public:
		...
		{
			return m_status == DiscoveryStatus::Discovering;
		}
		bool IsBroadcasting() const
		{
			return m_status == DiscoveryStatus::Broadcasting;
		}
		bool CanStartDiscovery() const
		{
			return m_status == DiscoveryStatus::Stopped;
		}
		bool CanStopDiscovery() const
		{
			return m_status != DiscoveryStatus::Stopped;
		}

		// 选中的对等节点 / Selected Peer
		std::shared_ptr<Models::PeerInfo> SelectedPeer() const
		{
		...
		{
			return static_cast<bool>(m_selectedPeer);
		}
		...
		std::wstring LocalPeerName() const
		{
			return m_localPeerName;
		}
		void LocalPeerName(std::wstring_view value)
		{
			SetProperty(m_localPeerName, std::wstring(value), L"LocalPeerName");
		}

		std::wstring LocalDeviceName() const
		{
			return m_localDeviceName;
		}
		void LocalDeviceName(std::wstring_view value)
		{
			SetProperty(m_localDeviceName, std::wstring(value), L"LocalDeviceName");
		}
		...
		uint32_t DiscoveryInterval() const
		{
			return m_discoveryInterval;
		}
		void DiscoveryInterval(uint32_t value)
		{
			SetProperty(m_discoveryInterval, value, L"DiscoveryInterval");
		}
		...
		void BroadcastInterval(uint32_t value)
		{
			SetProperty(m_broadcastInterval, value, L"BroadcastInterval");
		}
		...
		{
			SetProperty(m_autoConnect, value, L"AutoConnect");
		}

		// 统计信息 / Statistics
		uint32_t DiscoveredPeersCount() const
		{
			return m_discoveredPeersCount;
		}
		void DiscoveredPeersCount(uint32_t value)
		{
			SetProperty(m_discoveredPeersCount, value, L"DiscoveredPeersCount");
		}

		uint32_t ConnectedPeersCount() const
		{
			return m_connectedPeersCount;
		}
		void ConnectedPeersCount(uint32_t value)
		{
			SetProperty(m_connectedPeersCount, value, L"ConnectedPeersCount");
		}

		uint32_t TotalConnectionAttempts() const
		{
			return m_totalConnectionAttempts;
		}
		void TotalConnectionAttempts(uint32_t value)
		{
			SetProperty(m_totalConnectionAttempts, value, L"TotalConnectionAttempts");
		}

		uint32_t SuccessfulConnections() const
		{
			return m_successfulConnections;
		}
		...
		void LastError(std::wstring_view value)
		{
			SetProperty(m_lastError, std::wstring(value), L"LastError");
		}
		...
		// 命令 / Commands
		winrt::Microsoft::UI::Xaml::Input::ICommand StartDiscoveryCommand() const
		{
			return m_startDiscoveryCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand StopDiscoveryCommand() const
		{
			return m_stopDiscoveryCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand ConnectToPeerCommand() const
		{
			return m_connectToPeerCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand DisconnectFromPeerCommand() const
		{
			return m_disconnectFromPeerCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand AddToFavoritesCommand() const
		{
			return m_addToFavoritesCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand RemoveFromFavoritesCommand() const
		{
			return m_removeFromFavoritesCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand RefreshPeerListCommand() const
		{
			return m_refreshPeerListCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand BlockPeerCommand() const
		{
			return m_blockPeerCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand ClearPeerListCommand() const
		{
			return m_clearPeerListCommand;
		}
