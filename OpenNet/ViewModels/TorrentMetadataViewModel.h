...
namespace winrt::OpenNet::ViewModels::implementation
{
		...
		::OpenNet::ViewModels::ObservableMixin<TorrentFileNodeViewModel>
	{
		...
		void FullPath(winrt::hstring const& v)
		{
			SetProperty(m_fullPath, v, L"FullPath");
		}
		...
		void SizeText(winrt::hstring const& v)
		{
			SetProperty(m_sizeText, v, L"SizeText");
		}
		...
		void SizeBytes(std::int64_t v)
		{
			SetProperty(m_sizeBytes, v, L"SizeBytes"); RaisePropertyChanged(L"SizeText");
		}
		...
		void IsExpanded(bool v)
		{
			SetProperty(m_isExpanded, v, L"IsExpanded");
		}

		std::int32_t FileIndex() const
		{
			return m_fileIndex;
		}
		void FileIndex(std::int32_t v)
		{
		...
		void Priority(std::int32_t v)
		{
			SetProperty(m_priority, v, L"Priority"); RaisePropertyChanged(L"PriorityText");
		}

		winrt::hstring PriorityText() const;

		winrt::Windows::Foundation::Collections::IObservableVector<winrt::OpenNet::ViewModels::TorrentFileNodeViewModel> Children()
		{
			return m_children;
		}
	...
	private:
		...
		std::int64_t m_sizeBytes{};
		bool m_isFolder{ false };
		bool m_isExpanded{ true };
		std::int32_t m_fileIndex{ -1 };
		std::int32_t m_priority{ 4 };
		...
		::OpenNet::ViewModels::ObservableMixin<TorrentFileInfoViewModel>
	{
		...
		void FileName(winrt::hstring const& v)
		{
			SetProperty(m_fileName, v, L"FileName");
		}

		winrt::hstring FilePath() const
		{
			return m_filePath;
		}
		void FilePath(winrt::hstring const& v)
		{
			SetProperty(m_filePath, v, L"FilePath");
		}

		winrt::hstring FileSize() const
		{
			return m_fileSize;
		}
		void FileSize(winrt::hstring const& v)
		{
			SetProperty(m_fileSize, v, L"FileSize");
		}

		std::int64_t FileSizeBytes() const
		{
			return m_fileSizeBytes;
		}
		void FileSizeBytes(std::int64_t v)
		{
			SetProperty(m_fileSizeBytes, v, L"FileSizeBytes");
		}
	...
	private:
		...
		std::int64_t m_fileSizeBytes{};
		bool m_isSelected{ true };
		std::int32_t m_priority{ 4 }; // Normal priority
		std::int32_t m_fileIndex{};
	};
		...
		::OpenNet::ViewModels::ObservableMixin<TorrentMetadataViewModel>
	{
		...
		// Properties
		winrt::hstring TorrentName() const
		{
			return m_torrentName;
		}
		void TorrentName(winrt::hstring const& v)
		{
			SetProperty(m_torrentName, v, L"TorrentName");
		}

		winrt::hstring InfoHash() const
		{
			return m_infoHash;
		}
		void InfoHash(winrt::hstring const& v)
		{
			SetProperty(m_infoHash, v, L"InfoHash");
		}

		winrt::hstring TotalSize() const
		{
			return m_totalSize;
		}
		void TotalSize(winrt::hstring const& v)
		{
			SetProperty(m_totalSize, v, L"TotalSize");
		}

		std::int64_t TotalSizeBytes() const
		{
			return m_totalSizeBytes;
		}
		void TotalSizeBytes(std::int64_t v)
		{
			SetProperty(m_totalSizeBytes, v, L"TotalSizeBytes");
		}

		winrt::hstring SelectedSize() const
		{
			return m_selectedSize;
		}
		void SelectedSize(winrt::hstring const& v)
		{
			SetProperty(m_selectedSize, v, L"SelectedSize");
		}

		std::int64_t SelectedSizeBytes() const
		{
			return m_selectedSizeBytes;
		}

		winrt::hstring Comment() const
		{
			return m_comment;
		}
		void Comment(winrt::hstring const& v)
		{
			SetProperty(m_comment, v, L"Comment");
		}

		winrt::hstring Creator() const
		{
			return m_creator;
		}
		void Creator(winrt::hstring const& v)
		{
			SetProperty(m_creator, v, L"Creator");
		}

		winrt::hstring CreationDate() const
		{
			return m_creationDate;
		}
		void CreationDate(winrt::hstring const& v)
		{
			SetProperty(m_creationDate, v, L"CreationDate");
		}
		...
		void PieceLength(int32_t v)
		{
			SetProperty(m_pieceLength, v, L"PieceLength");
		}

		int32_t NumPieces() const
		{
			return m_numPieces;
		}
		void NumPieces(int32_t v)
		{
			SetProperty(m_numPieces, v, L"NumPieces");
		}
		...
		winrt::hstring MetadataStatus() const
		{
			return m_metadataStatus;
		}
		void MetadataStatus(winrt::hstring const& v)
		{
			SetProperty(m_metadataStatus, v, L"MetadataStatus");
		}

		winrt::Windows::Foundation::Collections::IObservableVector<winrt::OpenNet::ViewModels::TorrentFileInfoViewModel> Files()
		{
			return m_files;
		}
		winrt::Windows::Foundation::Collections::IObservableVector<winrt::OpenNet::ViewModels::TorrentFileNodeViewModel> FileTree()
		{
			return m_fileTree;
		}
		int32_t TotalFileCount() const
		{
			return m_files.Size();
		}
		int32_t SelectedFileCount() const;

		winrt::Windows::Foundation::Collections::IObservableVector<winrt::hstring> Trackers()
		{
			return m_trackers;
		}

		winrt::hstring SavePath() const
		{
			return m_savePath;
		}
		void SavePath(winrt::hstring const& v)
		{
			SetProperty(m_savePath, v, L"SavePath");
		}
		...
		void CreateSubfolder(bool v)
		{
			SetProperty(m_createSubfolder, v, L"CreateSubfolder");
		}
		...
		void StartImmediately(bool v)
		{
			SetProperty(m_startImmediately, v, L"StartImmediately");
		}
	...
	private:
		...
		std::int64_t m_totalSizeBytes{};
		winrt::hstring m_selectedSize;
		std::int64_t m_selectedSizeBytes{};
