...
namespace OpenNet::ViewModels
{
	...
	public:
		...
		std::shared_ptr<Models::NetworkInfo> CurrentNetwork() const
		{
		...
		{
			return m_status == DetectionStatus::Detecting;
		}
		bool CanStartDetection() const
		{
			return m_status != DetectionStatus::Detecting;
		}

		// 网络信息属性 / Network Information Properties
		std::wstring NetworkType() const
		{
			return m_networkType;
		}
		void NetworkType(std::wstring_view value)
		{
			SetProperty(m_networkType, std::wstring(value), L"NetworkType");
		}

		std::wstring ConnectionStatus() const
		{
			return m_connectionStatus;
		}
		void ConnectionStatus(std::wstring_view value)
		{
			SetProperty(m_connectionStatus, std::wstring(value), L"ConnectionStatus");
		}

		std::wstring LocalIPAddress() const
		{
			return m_localIPAddress;
		}
		void LocalIPAddress(std::wstring_view value)
		{
			SetProperty(m_localIPAddress, std::wstring(value), L"LocalIPAddress");
		}

		std::wstring PublicIPAddress() const
		{
			return m_publicIPAddress;
		}
		void PublicIPAddress(std::wstring_view value)
		{
			SetProperty(m_publicIPAddress, std::wstring(value), L"PublicIPAddress");
		}

		std::wstring NATType() const
		{
			return m_natType;
		}
		void NATType(std::wstring_view value)
		{
			SetProperty(m_natType, std::wstring(value), L"NATType");
		}

		bool UPnPAvailable() const
		{
			return m_upnpAvailable;
		}
		...
		// 网络评分 / Network Score
		double NetworkScore() const
		{
			return m_networkScore;
		}
		...
		std::wstring SelectedSTUNServer() const
		{
			return m_selectedSTUNServer;
		}
		void SelectedSTUNServer(std::wstring_view value)
		{
			SetProperty(m_selectedSTUNServer, std::wstring(value), L"SelectedSTUNServer");
		}
		...
		// 命令 / Commands
		winrt::Microsoft::UI::Xaml::Input::ICommand StartDetectionCommand() const
		{
			return m_startDetectionCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand TestLatencyCommand() const
		{
			return m_testLatencyCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand TestBandwidthCommand() const
		{
			return m_testBandwidthCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand TestPortCommand() const
		{
			return m_testPortCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand RefreshCommand() const
		{
			return m_refreshCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand ExportReportCommand() const
		{
			return m_exportReportCommand;
		}
		winrt::Microsoft::UI::Xaml::Input::ICommand ClearHistoryCommand() const
		{
