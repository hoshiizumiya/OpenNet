...
namespace winrt::OpenNet::ViewModels::implementation
{
	...
	struct NetworkSettingsViewModel : NetworkSettingsViewModelT<NetworkSettingsViewModel>, ::OpenNet::ViewModels::ObservableMixin<NetworkSettingsViewModel>
	{
		...
		void IPv4Enabled(bool value)
		{
			SetProperty(m_ipv4Enabled, value, L"IPv4Enabled");
		}
		...
		void IPv6Enabled(bool value)
		{
			SetProperty(m_ipv6Enabled, value, L"IPv6Enabled");
		}

		// 协议配置 / Protocol Configuration
		winrt::OpenNet::Models::IPProtocolPriority ProtocolPriority() const
		{
			return m_protocolPriority;
		}
		void ProtocolPriority(winrt::OpenNet::Models::IPProtocolPriority value)
		{
			SetProperty(m_protocolPriority, value, L"ProtocolPriority");
		}

		winrt::OpenNet::Models::ConnectionProtocol PreferredProtocol() const
		{
			return m_preferredProtocol;
		}
		void PreferredProtocol(winrt::OpenNet::Models::ConnectionProtocol value)
		{
			SetProperty(m_preferredProtocol, value, L"PreferredProtocol");
		}
		...
		void EncryptionEnabled(bool value)
		{
			SetProperty(m_encryptionEnabled, value, L"EncryptionEnabled");
		}
