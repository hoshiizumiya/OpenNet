...
export module OpenNet.Extension.FrameworkElementExtensions;

import OpenNet.Extension.Predicates;
...
namespace OpenNet::Extension
{
	...
	public:
		...
		Start:
			...
			if (auto panel = element.try_as<winrt::Microsoft::UI::Xaml::Controls::Panel>())
			{
		...
		{
			winrt::Application app = winrt::Microsoft::UI::Xaml::Application::Current();
