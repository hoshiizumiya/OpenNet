...
namespace winrt::OpenNet::UI::Xaml::View::Pages::implementation
{
	...
	void NetworkSettingsPage::SaveAndApplyListenEndpoints()
	{
			...
			!IPv6ListenEndpoint().Validate())
		{
			ActualListenStatusText().Text(
				ResourceGetString(L"ViewNetworkSettingsPageInvalidEndpointBeforeUpdate"));
			return;
		}
		...
		{
			ActualListenStatusText().Text(
				ResourceGetString(L"ViewNetworkSettingsPageEndpointsSaved"));
		}
	...
	void NetworkSettingsPage::RefreshRuntimeListenStatus()
	{
		...
		{
			ActualListenPortText().Text(ResourceGetString(L"ViewNetworkSettingsPageNotRunning"));
			ActualListenEndpointText().Text(
				ResourceGetString(L"ViewNetworkSettingsPageEngineNotRunning"));
			ActualListenStatusText().Text(
				inputsValid
				? ResourceGetString(L"ViewNetworkSettingsPageEndpointsSavedForStartup")
				: ResourceGetString(L"ViewNetworkSettingsPageEditedEndpointInvalidNotSaved"));
			return;
		}
		...
		{
			ActualListenPortText().Text(ResourceGetString(L"ViewNetworkSettingsPageNotListening"));
			ActualListenEndpointText().Text(
				ResourceGetString(L"ViewNetworkSettingsPageNoListeningSocket"));
			if (!inputsValid)
			{
				ActualListenStatusText().Text(
					ResourceGetString(L"ViewNetworkSettingsPageEditedEndpointInvalidNotApplied"));
			}
			...
			{
				ActualListenStatusText().Text(
					ResourceGetString(L"ViewNetworkSettingsPageWaitingForListener"));
			}
			return;
		}
