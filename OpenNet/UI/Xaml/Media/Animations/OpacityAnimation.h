...
{
	struct OpacityAnimation : winrt::OpenNet::UI::Xaml::Media::Animations::factory_implementation::OpacityAnimationT<OpacityAnimation, implementation::OpacityAnimation>
	{
	};
}
