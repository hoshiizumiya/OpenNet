...
{
	struct ImplicitAnimationSet : winrt::OpenNet::UI::Xaml::Media::Animations::factory_implementation::ImplicitAnimationSetT<ImplicitAnimationSet, implementation::ImplicitAnimationSet>
	{
	};
}
