...
namespace winrt::OpenNet::UI::Xaml::Media::Animations::implementation
{
	...
	winrt::OpenNet::UI::Xaml::Media::Animations::ImplicitAnimationSet Implicit::GetShowAnimations(Microsoft::UI::Xaml::UIElement const& obj)
	{
		return obj.GetValue(ShowAnimationsProperty()).try_as<winrt::OpenNet::UI::Xaml::Media::Animations::ImplicitAnimationSet>();
	}

	void Implicit::SetShowAnimations(Microsoft::UI::Xaml::UIElement const& obj, winrt::OpenNet::UI::Xaml::Media::Animations::ImplicitAnimationSet const& value)
	{
		obj.SetValue(ShowAnimationsProperty(), value);
	}

	winrt::OpenNet::UI::Xaml::Media::Animations::ImplicitAnimationSet Implicit::GetHideAnimations(Microsoft::UI::Xaml::UIElement const& obj)
	{
		return obj.GetValue(HideAnimationsProperty()).try_as<winrt::OpenNet::UI::Xaml::Media::Animations::ImplicitAnimationSet>();
	}

	void Implicit::SetHideAnimations(Microsoft::UI::Xaml::UIElement const& obj, winrt::OpenNet::UI::Xaml::Media::Animations::ImplicitAnimationSet const& value)
	{
		obj.SetValue(HideAnimationsProperty(), value);
	}

	winrt::OpenNet::UI::Xaml::Media::Animations::ImplicitAnimationSet Implicit::GetAnimations(Microsoft::UI::Xaml::UIElement const& obj)
	{
		return obj.GetValue(AnimationsProperty()).try_as<winrt::OpenNet::UI::Xaml::Media::Animations::ImplicitAnimationSet>();
	}

	void Implicit::SetAnimations(Microsoft::UI::Xaml::UIElement const& obj, winrt::OpenNet::UI::Xaml::Media::Animations::ImplicitAnimationSet const& value)
	{
