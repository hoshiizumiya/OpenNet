...
export module OpenNet.UI.Xaml.Behavior;
...
// upstream: https://github.com/lgztx96/CommunityToolkit.WinUI/blob/master/XamlToolkit.WinUI.Behaviors/Behavior.h
export namespace winrt::XamlToolkit::WinUI::Behaviors
{
	/// <summary>
